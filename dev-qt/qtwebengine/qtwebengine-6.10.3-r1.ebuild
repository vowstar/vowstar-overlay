...
src_prepare() {
	...
	# Fix pyjson5 import with Python 3.13: namespace package resolution
	# fails without __init__.py when pyjson5 appears in multiple PYTHONPATH entries
	touch src/3rdparty/chromium/third_party/pyjson5/{,src/}__init__.py || die
