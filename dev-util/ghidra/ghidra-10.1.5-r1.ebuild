...
SRC_URI="https://github.com/NationalSecurityAgency/${PN}/archive/Ghidra_${PV}_build.tar.gz
	...
	https://downloads.sourceforge.net/yajsw/yajsw/yajsw-beta-13.01.zip
	https://dev.pentoo.ch/~blshkv/distfiles/cdt-8.6.0.zip
	https://downloads.sourceforge.net/project/pydev/pydev/PyDev%206.3.1/PyDev%206.3.1.zip -> PyDev-6.3.1.zip"
