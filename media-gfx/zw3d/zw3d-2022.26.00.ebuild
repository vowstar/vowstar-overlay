...
MY_PGK_NAME="com.zwsoft.zw3dpreview"
...
src_install() {
	...
	sed -i '6c Icon=ZW3Dpreview'     "${WORKDIR}/usr/share/applications/${MY_PGK_NAME}.desktop" || die
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${MY_PKG_HOME}/lib:${MY_PKG_HOME}/lib/xlator:${MY_PKG_HOME}/libqt:${MY_PKG_HOME}/libqt/plugins/designer:${MY_PKG_HOME}/lib3rd
cd /opt/${MY_PGK_NAME}/files
./zw3d $*
	EOF
